/* Formatted on 10/3/2014 3:40:21 PM (QP5 v5.126.903.23003) */
-- FUNCTION: APLAPPS.GET_PRNT_TRNS_SUM(INTEGER, CHARACTER VARYING, CHARACTER VARYING)

-- DROP FUNCTION APLAPPS.GET_PRNT_TRNS_SUM(INTEGER, CHARACTER VARYING, CHARACTER VARYING);

CREATE OR REPLACE FUNCTION APLAPPS.GET_PRNT_TRNS_SUM (
