/* Formatted on 12-19-2018 11:12:57 AM (QP5 v5.126.903.23003) */
CREATE OR REPLACE FUNCTION WKF.ACTION_SQL_FOR_SYSINBX (ROUTNGID     NUMBER,
                                                       USRID        NUMBER,
                                                       ACTTOPRFM    VARCHAR2)
   RETURN VARCHAR2
AS
...
EXCEPTION
   ...
   THEN
      ...
      RESULT := RESULT || '<br/>' || '' || SQLSTATE || '<br/>' || SQLERRM;
