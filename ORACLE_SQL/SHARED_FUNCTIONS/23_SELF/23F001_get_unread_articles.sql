/* Formatted on 12-19-2018 11:16:42 AM (QP5 v5.126.903.23003) */
CREATE OR REPLACE FUNCTION SELF.GET_UNREAD_ARTICLES (P_PERSON_ID NUMBER)
   RETURN INTEGER
AS
   BID   INTEGER := 0;
BEGIN
   SELECT   COUNT (1)
    ...
    WHERE       A.ARTICLE_ID = E.ARTICLE_ID
            ...
            AND E.ARTICLE_CATEGORY NOT IN ('Forum Topic', 'Chat Room');
