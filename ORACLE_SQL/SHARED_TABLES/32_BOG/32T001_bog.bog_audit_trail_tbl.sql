/* Formatted on 10/6/2014 9:10:32 PM (QP5 v5.126.903.23003) */
-- TABLE: WKF.WKF_HIERARCHY_HDR

-- DROP TABLE WKF.WKF_HIERARCHY_HDR;
...
/*
CREATE INDEX WKF.IDX_HIERARCHY_ID
   ON WKF.WKF_HIERARCHY_HDR (HIERARCHY_ID)
   LOGGING
   TABLESPACE RHODB
   PCTFREE 10
   INITRANS 2
